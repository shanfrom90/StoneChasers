...
namespace Sailing_Rocks.Migrations
{
    ...
    [Migration("20210422153600_updatedSeedData")]
            ...
            modelBuilder.Entity("Sailing_Rocks.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Lat = "41.363528",
                            Lng = "-81.851403",
                            LocatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 485, DateTimeKind.Local).AddTicks(2858),
                        ...
                        new
                        {
                            ...
                            Lat = "41.435258",
                            Lng = "81.845719",
                            LocatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 485, DateTimeKind.Local).AddTicks(5049),
                        ...
                        new
                        {
                            ...
                            Lat = "41.486700",
                            Lng = "-81.902125",
                            LocatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 485, DateTimeKind.Local).AddTicks(5101),
                        ...
                        new
                        {
                            ...
                            LocatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 485, DateTimeKind.Local).AddTicks(5107),
                        ...
                        new
                        {
                            ...
                            LocatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 485, DateTimeKind.Local).AddTicks(5112),
            ...
            modelBuilder.Entity("Sailing_Rocks.Models.Rock", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 484, DateTimeKind.Local).AddTicks(7635),
                        ...
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 484, DateTimeKind.Local).AddTicks(9881),
                        ...
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 484, DateTimeKind.Local).AddTicks(9935),
                            Description = "Make a Wish",
                            Image = "https://photos.google.com/share/AF1QipMhD_8LIwkZJi6zkrublKRvVAfR6pP_QzzISOJYEd5qQanOsON2k9dJG1wZE7MKwQ/photo/AF1QipPMjVBXxBRCw4HyfvFWsV-c-NVrAZFmpjW8mMMx?key=MXJhTHFJdXgyUDM4ZXZ1YWlCcVBDaEVoTC0wLThR",
                            Name = "Dandelion",
                            Serial = "BCDG2346",
                            UserId = 3
                        },
                        ...
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 484, DateTimeKind.Local).AddTicks(9941),
                            Description = "Make a Wish",
                            Image = "https://photos.google.com/share/AF1QipMhD_8LIwkZJi6zkrublKRvVAfR6pP_QzzISOJYEd5qQanOsON2k9dJG1wZE7MKwQ/photo/AF1QipO8TrpRxfaoVT4Z99darKiTUWsgKEG00bf_tCS_?key=MXJhTHFJdXgyUDM4ZXZ1YWlCcVBDaEVoTC0wLThR",
                            Name = "Heart You",
                            Serial = "BCDP2346",
                            UserId = 4
                        });
            ...
            modelBuilder.Entity("Sailing_Rocks.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 477, DateTimeKind.Local).AddTicks(2829),
                        ...
                        new
                        {
                            Id = 2,
                            Bio = "Software Developer",
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 482, DateTimeKind.Local).AddTicks(9432),
                        ...
                        new
                        {
                            Id = 3,
                            Bio = "Avid Hiker",
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 482, DateTimeKind.Local).AddTicks(9550),
                        ...
                        new
                        {
                            Id = 4,
                            Bio = "Fitness Fiend",
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 482, DateTimeKind.Local).AddTicks(9560),
                        ...
                        new
                        {
                            Id = 5,
                            Bio = "Artist",
                            CreatedOn = new DateTime(2021, 4, 22, 11, 35, 59, 482, DateTimeKind.Local).AddTicks(9566),
                            Email = "JE@gmail.com",
                            FirstName = "JE",
                            Hometown = "Cincinnati, OH",

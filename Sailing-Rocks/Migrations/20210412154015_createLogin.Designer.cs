...
namespace Sailing_Rocks.Migrations
{
    ...
    [Migration("20210412154015_createLogin")]
            ...
            modelBuilder.Entity("Sailing_Rocks.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LocatedOn = new DateTime(2021, 4, 12, 11, 40, 15, 73, DateTimeKind.Local).AddTicks(9993),
            ...
            modelBuilder.Entity("Sailing_Rocks.Models.Rock", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 4, 12, 11, 40, 15, 73, DateTimeKind.Local).AddTicks(5157),
            ...
            modelBuilder.Entity("Sailing_Rocks.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2021, 4, 12, 11, 40, 15, 67, DateTimeKind.Local).AddTicks(1374),
